    ...
    return (
        <div>
            ...
            <div className={styles.zonesWrapper}>
                <Zone name={dict.page.home.zones.tlz.name} description={dict.page.home.zones.tlz.description} id="temporalLandingZone" />
                <Zone name={dict.page.home.zones.lz.name} description={dict.page.home.zones.lz.description} id="temporalLandingZone" />
                <Zone name={dict.page.home.zones.fz.name} description={dict.page.home.zones.fz.description} id="temporalLandingZone" />
            </div>
